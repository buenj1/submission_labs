/** \mainpage Driver Overview
  ...
  * - <b>Project file</b>:     C:/Users/jbuen/workspace_v9/empty_CC1350_LAUNCHXL_tirtos_ccs/adclvltrigger.scp
  * - <b>Code prefix</b>:      -
  * - <b>Operating system</b>: TI-RTOS
  * - <b>Tool version</b>:     2.5.0.84
  * - <b>Tool patches</b>:     1, 2 and 3
  * - <b>Target chip</b>:      CC1350, package QFN48 7x7 RGZ, revision -
  * - <b>Created</b>:          2019-12-04 19:59:58.598
  * - <b>Computer</b>:         DESKTOP-VIO14N3
  * - <b>User</b>:             John Patrick
  *
  ...
  * - adc level trigger:
  *     - <b>A: ADC input to internal ADC</b>: DIO29
  *     - <b>O: Green LED on LaunchPad</b>: DIO7
...
/// adc level trigger I/O mapping: ADC input to internal ADC
#define SCIF_ADC_LEVEL_TRIGGER_DIO_A_ADC_INPUT 29
/// adc level trigger I/O mapping: Green LED on LaunchPad
#define SCIF_ADC_LEVEL_TRIGGER_DIO_O_GREEN_LED 7
/// adc level trigger I/O mapping: Digital Output Low
#define SCIF_ADC_LEVEL_TRIGGER_DIO_O_LOW 28
/// adc level trigger I/O mapping: Digital Output High
...
typedef struct {
    uint16_t threshold; ///< Cfg structure that indicates if the sampled ADC value is above or below the assigned threshold.
} SCIF_ADC_LEVEL_TRIGGER_CFG_T;


/// adc level trigger: Task output data structure
typedef struct {
    uint16_t adcValue; ///< Output structure to store sampled ADC value
} SCIF_ADC_LEVEL_TRIGGER_OUTPUT_T;


/// adc level trigger: Task state structure
typedef struct {
    uint16_t high; ///< State structure that indicates the state of the ADC value being above/below the threshold.
