...
int main(void)
{
    ...
    ui8Adjust = 35; // value represents 1ms of PWM ON time (servo at 0 or 180 degrees)
    ...
    while(1)
    {
        //continuous sweep from 0 to 180 degrees
        while (ui8Adjust < 135)
        {
            ui8Adjust++;
        ...
        ROM_SysCtlDelay(2000000); // small delay in between sweep
